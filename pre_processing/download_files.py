    ...
    with open(args.samples_file) as infile_handle:
        with open(args.output_samples_file, "w") as outfile_handle:
            ...
            for line in infile_handle:
                ...
                res[1:] = [os.path.join(args.input_dir, el.rsplit("/", 1)[-1])
                           if el else "" for el in res[1:]]
