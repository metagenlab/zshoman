...
- Update mOTUs to version 4. [#64](https://github.com/metagenlab/zshoman/pull/64)) (Niklaus Johner)
- Use merged gene abundance file for computing annotation abundances. [#64](https://github.com/metagenlab/zshoman/pull/64)) (Niklaus Johner)
